  ...
  grunt.initConfig({
    ...
    compass: {
      options: {
        ...
        fontsDir: '<%= project.src %>/css/fonts',
...
//      css: ['<%= project.dist %>/styles/{,*/}*.css'],
    ...
    cssmin: {
       dist: {
         files: {
           '<%= project.dist %>/daterangepicker-compare.min.css':
             ['<%= project.src %>/css/*.css']
         }
       }
    },
    ...
    uglify: {
      options: {
        ...
        sourceMap: '<%= project.dist %>/daterangepicker-compare.min.js.map',
        sourceMappingURL: 'daterangepicker-compare.min.js.map',
        report: 'min'
      },
      dist: {
        files: {
          '<%= project.dist %>/daterangepicker-compare.min.js': ['<%= project.src %>/js/*.js']
        }
      }
    },
